    ...
    >
      ...
      <div>
        <Select
          ...
          onChange={(option) => {
            ...
            GetCity(formik.values.countryId.value, option.value).then(
              (result) => setCityList(result)
            );
          }}
      ...
      <div>
        <Select
          ...
          isDisabled={!formik.values.stateId}
        />
      </div>
      ...
      <div>
        <input
          ...
          className="mt-2 block w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-blue-500"
        />
      ...
      <button
        type="submit"
        className="w-auto px-5 bg-blue-500 text-white p-2 rounded hover:bg-blue-600 transition duration-200"
      >
        Submit
      </button>
    </form>
